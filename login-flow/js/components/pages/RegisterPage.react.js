...
export default class RegisterPage extends Component {
    ...
    return (
			<div className="form-page__wrapper">
		    	...
		    	<Form data={formState} dispatch={dispatch} location={location} history={this.props.history} onSubmit={::this._register} btnText={"Sign up"} currentlySending={currentlySending}/>
				</div>
			</div>
		);
  }
	...
	// Register a user
	_register(username, password,email,subscribername) {
