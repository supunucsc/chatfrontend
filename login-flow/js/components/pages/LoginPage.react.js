...
export default class LoginPage extends Component {
    ...
    return (
			<div className="form-page__wrapper">
		    	...
		    	<Form data={formState} dispatch={dispatch} location={location} history={this.props.history} onSubmit={::this._login} btnText={"Sign in"} currentlySending={currentlySending}/>
				</div>
			</div>
		);
  }
