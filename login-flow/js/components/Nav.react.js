  ...
  render() {
    ...
    const navButtons = this.props.loggedIn ? (
        ...
        <div>
          ...
          <Link to="/login" className="btn btn--login btn--nav">Sign in</Link>
        </div>
      );
    ...
    return(
      <div className="nav">
        <div className="nav__wrapper">
          <Link to="/" className="nav__logo-wrapper"><h1 className="nav__logo">Enterprise Chat Message Manager</h1></Link>
          { navButtons }
        </div>
      </div>
    );
